...
\subsection{Parallelenaxiom/-problem (Euklid, Formulierung nach Playfair)}\index{Parallelenaxiom/-problem}
...
\subsection{Definition (Gruppe)}
 	\begin{Definition}[Gruppe]\index{Gruppe}
 ...
 \subsection{Definition (Gruppenoperation)}
 	\begin{Definition}[Gruppenoperation]\index{Gruppe!Gruppenoperation}\index{Gruppe!Transformations-}
 ...
 \subsection{Beispiel und Definition (Permutationsgruppe)}
 	\begin{Definition}[Permutationsgruppe]\index{Gruppe!Permutations-}
 ...
 \subsection{Definition (Körper)}
 	\begin{Definition}[Körper]\index{Körper}
...
%VO04-2015-10-15
 ...
 \subsection{Bemerkung und Definition (Charakteristik)}
 	\begin{Definition}[Charakteristik]\index{Körper!Charakteristik}
...
\subsection{Translationen und Vektoren}
	...
	\begin{tikzpicture}[xscale=0.9,scale=1.5,>=triangle 45]
 		...
 		\draw (5,0.5) node[] {$z=z'\Rightarrow$ Translationen \glqq der\grqq{} Ebene bilden eine abelsche Gruppe};
	\end{tikzpicture}
 ...
 \subsection{Definition (Vektorraum)}
 	\begin{Definition}[Vektorraum]\index{Vektorraum}
 ...
 \subsection{Beispiel und Definition (Standardvektorraum)}
 	\begin{Definition}[Standardvektorraum]\index{Vektorraum!Standard-}
