...
\section{Homomorphismen}
 \subsection{Definition}
 	\begin{Definition}[Homomorphismus]\index{Homomorphismus}
 ...
 \subsection{Bemerkung \& Definition}
 	...
 	\paragraph{Beispiel}
 		...
 		\]
 		ein Homomorphismus von $ V $ in sich, $\eta_y\in \hom(V,V)$. Eine Streckung nennt man auch \emph{Homothetie}.\index{Homothetie}
 ...
 \subsection{Fortsetzungssatz}
 	\begin{Satz}[Fortsetzungssatz]\index{Fortsetzungssatz}
 ...
 \subsection{Beispiel und Definition}
 	\begin{Definition}[Dualraum]\index{Dualraum}
 		...
 		\[
 			\forall j\in \{1,...,n\}: V^* \ni b_i^*(b_j)=\delta_{ij}
 		\]
 		eine Basis $B^*=(b^*_1,\dots,b^*_n)$ von $V^*$: die zu $B$ \emph{duale Basis} von $V^\ast$.\index{Basis!duale}
 	\end{Definition}
...
%VO09-2015-11-03
 ...
 \subsection{Lemma und Definition}
 	\begin{Definition}\index{Bild}\index{Kern}\index{Rang}\index{Defekt}
 ...
 \subsection{Rangsatz}
 	\begin{Satz}[Rangsatz]\index{Rang!-satz}
...
%VO09-2015-11-05
 ...
 \subsection{Definition}
 	\begin{Definition}[Spezielle Homomorphismen]\index{Homomorphismen!besondere}\index{Endomorphismus}\index{Isomorphismus}\index{Automorphismus}
 ...
 \subsection{Isomorphielemma}
 	\begin{Lemma}[Isomorphielemma]\index{Isomorphielemma}
