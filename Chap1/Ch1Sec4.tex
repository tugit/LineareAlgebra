...
\paragraph{Behauptung: }
	$(c_i)_{c\in I}$ ist eine Basis von $f(V)$.	Lineare Unabhängigkeit: gilt für eine Linearkombination in $(c_i)_{i\in I}$:
	\begin{equation*}
...
\paragraph{Definition: }
	...
	\begin{enumerate}
		...
		\item Automorphismus, $f\in Ant(V)$, falls W=V und f bijektiv ist
	\end{enumerate}
