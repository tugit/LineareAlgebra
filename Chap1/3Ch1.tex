...
\section{Basis und Dimensionen}
 ...
 \subsection{Definition}
 	\begin{Definition}[Basis]\index{Basis}\index{Lineare Unabhängigkeit}\index{Erzeugendensystem}
 ...
 \subsection{Beispiel und Definition}
 	\begin{Definition}[Standardbasis]\index{Basis!Standard-}
...
%VO07-2015-10-27
 \subsection{Basislemma}
 	\begin{Lemma}[Basislemma]\index{Basis!-lemma}
 ...
 \subsection{Basisergänzungssatz}
 	\begin{Satz}[Basisergänzungssatz]\index{Basis!-ergänzungssatz}
 ...
 \subsection{Austauschlemma}
 	\begin{Lemma}[Austauschlemma]\index{Austauschlemma}
 ...
 \subsection{Basissatz}
 	\begin{Satz}[Basissatz]\index{Basis!-satz}
