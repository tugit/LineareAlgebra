...
\paragraph{Bemerkung: }
	Offenbar ist $ \sum_{i\in I} U_i\subset V $ UVR mit $ \bigcup_{i\in I}U_i \subset \sum_{i\in I} U_i \Rightarrow [\bigcup_{i\in I}U_i]\subset \sum_{i\in I} U_i $;
	andererseits gilt: $ \sum_{i\in I}U_i \subset \{\sum_{j\in J}v_jx_j\mid \forall j\in Jv_j\in \bigcup_{i\in I}U_i \land \#\{j\in J\mid x_j\neq 0\}<\infty\}\subset [\bigcup_{i\in I}U_i] $.
...
\paragraph{Beweis: }
	...
	$ B $ lin. unabh.: Gegeben sei eine Linearkombination von $ 0\in U $,
		\begin{gather*}
	...
	Mit der lin. Unabhängigkeit von $ B_0, S_1 $ und $ S_2 $ folgt dann
		\begin{equation*}
...
\paragraph{Beweis: }
	...
	Definiere $ U':= [S] $. Dann ist $ U'\subset V $ UVR mit
		...
		\item $ U\cap U' = [B]\cap [S] = \{o\}$, da $ C=B\cup S $ lin. unabh.
		\end{enumerate}
\paragraph{Bemerkung: }
