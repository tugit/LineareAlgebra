...
\section{Summen, Produkte und Quotienten}
 \subsection{Definition (Summe von UVR)}
 	\begin{Definition}[Summe von UVR]\index{Untervektorraum!Summe}
 ...
 \subsection{Dimensionssatz}
 	\begin{Satz}[Dimensionssatz]\index{Dimensions!-satz}
 ...
 \subsection{Definition (Komplementäre UVR)}
 	\begin{Definition}[Komplementäre UVR]\index{Untervektorraum!komplementär}
 ...
 \subsection{Lemma \& Definition (direkte Summe)}
 	\begin{Definition}[Direkte Summe]\index{Untervektorraum!Direkte Summe}
 	...
 	\paragraph{Bemerkung}
 		...
 		und es gilt die \emph{Dimensionsformel für direkte Summen} (Beweis: Aufgabe 35):\index{Dimensions!-formel}
 		\begin{equation*}
...
%VO11-2015-11-12
 ...
 \subsection{Beispiel und Definition}
 	\begin{Definition}[]\index{Involution}
 ...
 \subsection{Lemma und Definition}
 	\begin{Definition}[Produkt von VR]\index{Vektorraum!Produkt}
 ...
 \subsection{Lemma und Definition}
 	\begin{Definition}[Nebenklassen]\index{Nebenklasse}
 		...
 		\end{align*}
 		definierten Operationen ein Vektorraum: der \emph{Quotientenraum} $V/U$.\index{Quotientenraum}
 	\end{Definition}
...
%VO12-2015-11-17
 \subsection{Bemerkung \& Definition}
 	\begin{Definition}[Äquivalenzrelation]\index{Äquivalenzrelation}
 ...
 \subsection{Homomorphiesatz für lineare Abbildungen}
 	\begin{Satz}[Homomorphiesatz für lineare Abbildungen]\index{Homomorphiesatz}
