...
\section{Summen, Produkte und Quotienten}
 \subsection{Definition (Summe von UVR)}
 	\begin{Definition}[Summe von UVR]\index{Summe von UVR}
 ...
 \subsection{Dimensionssatz}
 	\begin{Satz}[Dimensionssatz]\index{Dimensionssatz}
 ...
 \subsection{Lemma \& Definition (direkte Summe)}
 	\begin{Definition}[Direkte Summe]\index{Direkte Summe}
...
%VO11-2015-11-12
 ...
 \subsection{Lemma und Definition (Produkt von VR)}
 	\begin{Definition}[Produkt von VR]\index{Produkt von VR}
 ...
 \subsection{Lemma und Definition (Nebenklassen)}
 	\begin{Definition}[Nebenklassen]\index{Nebenklassen}
