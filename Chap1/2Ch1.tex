...
\section{Unterräume und Lineare Hülle}
 \subsection{Definition (Untervektorraum)}
 	\begin{Definition}[Untervektorraum]\index{Vektorraum!Unter-}
 ...
 \subsection{Definition}
 	\begin{Definition}\index{Lineare Hülle}
 	...
 	\paragraph{Beispiel}
 		...
 		\begin{equation*}
 			...
 			\end{cases}
 		\end{equation*}
 		das \emph{Kroneckersymbol} bezeichnet.\index{Kroneckersymbol}
 ...
 \subsection{Definition}
 	\begin{Definition}\index{Linearkombination}
