...
%VO_17.12.15
\paragraph{Bemerkung}
	Jede Lösung $ X $ eines (inhomogenen) linearen Gleichungssystems lässt sich schreiben als Summe einer \emph{Partikulärlösung} $ X_0 \in K^{n\times 1},AX_0 = Y $, und einer Lösung des homogenen LGS $ AX = 0 $:
