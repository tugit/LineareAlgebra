...
\section{Determinantenformen}
 ...
 \subsection{Wiederholung \& Definition}
 	...
 	\begin{Definition}[Transposition]\index{Transposition}
 ...
 \subsection{Lemma \& Definition}
 	\begin{Definition}[Signum einer Permutation]\index{Signum einer Permutation}
...
%VO22-2016-01-12
 ...
 \subsection{Buchhaltung}
 	\begin{Definition}[Determinante]\index{Determinante}
 		Mit
 		\[
 	...
 	\end{align*}
 	\begin{Definition}[Transponierte Matrix]\index{Transponierte Matrix}
...
%VO23-2016-01-14
 \subsection{Beispiel \& Definition (Blockmatrix)}
 	\begin{Definition}[Blockmatrix]\index{Blockmatrix}
