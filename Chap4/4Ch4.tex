...
\begin{Definition}[Eigenwert,Eigenvektor,Eigenraum]
	Seien $ V $ ein $ K $-VR und $ f\in\End(V) $. Dann heißen
		\begin{enumerate}[(i)]
			\item $ x\in K $ ein Eigenwert von $ f $, falls \hfill $ \exists v\in V^\times: f(v)=vx; $
			\item $ v\in V^\times $ ein Eigenvektor von $ f $, falls \hfill $\exists x\in K:f(v)=vx; $
			\item $ \ker(f-\id_Vx) \subset V $ ein Eigenraum, falls\hfill $\ker(f-\id_Vx) \neq \{0\}.$
		\end{enumerate}
	\end{Definition}
\paragraph{Bemerkung}
