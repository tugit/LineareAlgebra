...
\subsection{Definition}\index{Algebra}
	...
	Eine $ K $-Algebra heißt
		\begin{itemize}
			\item unitär (mit Einselement 1), falls \hfill$ \exists 1\in V^\times\forall v\in V: 1\odot v = v\odot 1 = v $;
	...
	\end{Definition}
\paragraph{Beispiel}
	Die additive Gruppe $ \End(V) $ ist (mit Komposition) eine unitäre assoziative Algebra.
\paragraph{Bemerkung}
