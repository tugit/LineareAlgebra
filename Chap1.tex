...
ERGÄNZUNG durch Wiederholung

\paragraph{Satz:}
	$\dim\hom (V,W) = m\cdot n$, falls $m:=\dim W<\infty, n:=\dim V< \infty$
\paragraph{Beweis:}
	...
	Wir wählen (nach BES) Basen $B = (b_1,...,b_n)$ von $V$ und $C=(c_1,...,c_m)$ von $W$ und definieren
		\begin{equation*}
			f_{ij}\in \hom (V,W) mit f_{ij}:= c_i\cdot b_j^* \text{ für } 
				\begin{cases}\paragraph{Beispiel und Definition:}
	Der Dualraum $V^\ast := \hom(V,K)$ eines $K$-VRs $V$ ist ein $ K $-VR $(\subset K^V)$. Ist $\dim V=:n<\infty$ so ist $\dim V^\ast=n$.
	Nämlich: ist $B=(b_i, ... ,b_n)$ eine Basis von $ V $, so definieren wir für $ i = \{1, ... ,n\} $ (nach Fortsetzungssatz): $b_i^\ast\in V^\ast$ durch $\forall j\in \{1,...,n\}:b_i^\ast(b_j)=\delta_{ij}$ eine Basis $B^\ast=(b_i^\ast,...,b_n^\ast)$ von $V^\ast$, die zu $ B $ duale Basis $B^\ast$ von $V^\ast$
...
\paragraph{Beweis:}
	...
	Seien nun $\dim V = n < \infty$ und $\dim W = m < \infty$.
					...
					i\in I := \{1,...,m\}\\
					j\in J := \{1,...,n\}\paragraph{Beispiel und Definition:}
	Der Dualraum $V^\ast := \hom(V,K)$ eines $K$-VRs $V$ ist ein $ K $-VR $(\subset K^V)$. Ist $\dim V=:n<\infty$ so ist $\dim V^\ast=n$.
	Nämlich: ist $B=(b_i, ... ,b_n)$ eine Basis von $ V $, so definieren wir für $ i = \{1, ... ,n\} $ (nach Fortsetzungssatz): $b_i^\ast\in V^\ast$ durch $\forall j\in \{1,...,n\}:b_i^\ast(b_j)=\delta_{ij}$ eine Basis $B^\ast=(b_i^\ast,...,b_n^\ast)$ von $V^\ast$, die zu $ B $ duale Basis $B^\ast$ von $V^\ast$
...
\paragraph{Beweis: }
	Zu zeigen: $f(V)\subset W$ und $\ker f\subset V$ sind UVR. Nach Bemerkung gilt $f(V)\neq \emptyset$ und $\ker f \neq \emptyset$ -- wir verwenden dann das UR-Kriterium.
...
\paragraph{Bemerkung: }
	Allgemeiner kann man für $f\in \hom (V,W)$ zeigen:
		...
		\end{enumerate}
\paragraph{Bemerkung: }
	$f\in \hom (V,W)$ ist genau dann injektiv, wenn $\ker f = \{o\}$. Nämlich:
		\begin{itemize}
