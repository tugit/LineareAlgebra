...
\draw[fill,color=red] (0,0.75,1) circle [x=1cm,y=1cm,radius=0.05]node[below,label={[xshift=0, yshift=-34]$Äquivalenzklasse \ \mathbb{R}^2_{(x,y)}$}]{$(x,y)\sim (\tilde{x},\tilde{y})$};
