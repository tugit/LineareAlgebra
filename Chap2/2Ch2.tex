...
%-------------------Begin Baryzentrisches Bezugssystem mit affiner Abbildung----------------  
...
%Geraden
\draw[-,shorten >=3pt, shorten <=3pt,line width=0.2pt,color=red] (pointa) -- (pointc) -- (pointb) -- (pointa);

\draw[-,shorten >=3pt, shorten <=3pt,line width=0.2pt,color=red] (pointas) -- (pointcs) -- (pointbs) -- (pointas);
...
%Punkte malen
\draw[fill,color=red] (pointa) circle [x=1cm,y=1cm,radius=0.08]node[ xshift=-10]{$a$};
...
\draw[fill,color=red] (pointas) circle [x=1cm,y=1cm,radius=0.08]node[ xshift=10,yshift=10 ]{$a'$};
\draw[fill,color=red] (pointbs) circle [x=1cm,y=1cm,radius=0.08]node[ xshift=10]{$b'$};
\draw[fill,color=red] (pointcs) circle [x=1cm,y=1cm,radius=0.08]node[ xshift=-10]{$c'$};

\end{tikzpicture}
\end{figure}
%-------------------End Baryzentrisches Bezugssystem mit affiner Abbildung----------------  
